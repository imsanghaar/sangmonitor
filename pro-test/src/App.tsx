...
const Footer = () => (
  <footer className="border-t border-wm-border bg-[#020202] pt-24 pb-12 px-6 text-center" id="waitlist">
    ...
    <div className="flex flex-col md:flex-row items-center justify-between max-w-7xl mx-auto pt-8 border-t border-wm-border/50 text-xs text-wm-muted font-mono">
      ...
      <div className="flex gap-6">
        <a href="https://x.com/SangMonitorApp" target="_blank" rel="noreferrer" aria-label="Follow Sang Monitor on X" className="hover:text-wm-text transition-colors">X</a>
        <a href="https://github.com/imsanghaar/sangmonitor" target="_blank" rel="noreferrer" aria-label="Sang Monitor on GitHub" className="hover:text-wm-text transition-colors">GitHub</a>
        <a href="https://www.wired.me/story/the-music-streaming-ceo-who-built-a-global-war-map" target="_blank" rel="noreferrer" aria-label="Read the WIRED article about Sang Monitor" className="hover:text-wm-text transition-colors">{t('footer.wiredArticle')}</a>
      </div>
    </div>
  </footer>
);
    ...
    <footer className="border-t border-wm-border bg-[#020202] py-8 px-6 text-center">
      <div className="flex flex-col md:flex-row items-center justify-between max-w-7xl mx-auto text-xs text-wm-muted font-mono">
        ...
        <div className="flex gap-6">
          <a href="#" onClick={(e) => { e.preventDefault(); window.location.hash = ''; }} className="hover:text-wm-text transition-colors">{t('nav.pro')}</a>
          <a href="https://x.com/SangMonitorApp" target="_blank" rel="noreferrer" aria-label="Follow Sang Monitor on X" className="hover:text-wm-text transition-colors">X</a>
          <a href="https://github.com/imsanghaar/sangmonitor" target="_blank" rel="noreferrer" className="hover:text-wm-text transition-colors">GitHub</a>
        </div>
      </div>
    </footer>
  </div>
