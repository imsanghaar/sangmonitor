...
const VARIANT_HOST_MAP: Record<string, string> = {
  'sang-tech.vercel.app': 'tech',
  'sang-finance.vercel.app': 'finance',
  'sang-happy.vercel.app': 'happy',
  'sang-commodity.vercel.app': 'commodity',
};
...
const VARIANT_OG: Record<string, { title: string; description: string; image: string; url: string }> = {
  tech: {
    title: 'Sang Tech Monitor - Real-Time AI & Tech Industry Dashboard',
    description: 'Real-time AI and tech industry dashboard tracking tech giants, AI labs, startup ecosystems, funding rounds, and tech events worldwide.',
    image: 'https://sang-tech.vercel.app/favico/tech/og-image.png',
    url: 'https://sang-tech.vercel.app/',
  },
  finance: {
    title: 'Sang Finance Monitor - Real-Time Markets & Trading Dashboard',
    description: 'Real-time finance and trading dashboard tracking global markets, stock exchanges, central banks, commodities, forex, crypto, and economic indicators worldwide.',
    image: 'https://sang-finance.vercel.app/favico/finance/og-image.png',
    url: 'https://sang-finance.vercel.app/',
  },
  happy: {
    title: 'Sang Happy Monitor - Good News & Global Progress',
    description: 'Curated positive news, progress data, and uplifting stories from around the world.',
    image: 'https://sang-happy.vercel.app/favico/happy/og-image.png',
    url: 'https://sang-happy.vercel.app/',
  },
  commodity: {
    title: 'Sang Commodity Monitor - Real-Time Commodity Markets & Supply Chain Dashboard',
    ...
    image: 'https://sang-commodity.vercel.app/favico/commodity/og-image.png',
    url: 'https://sang-commodity.vercel.app/',
  },
};
