...
export const VARIANT_META: { full: VariantMeta; [k: string]: VariantMeta } = {
  full: {
    title: 'Sang Monitor - Real-Time Global Intelligence Dashboard',
    ...
    url: 'https://sang-monitor.vercel.app/',
    siteName: 'Sang Monitor',
    shortName: 'SangMonitor',
  ...
  tech: {
    ...
    siteName: 'Sang Tech Monitor',
    shortName: 'SangTechMonitor',
  ...
  happy: {
    ...
    siteName: 'Sang Happy Monitor',
    shortName: 'SangHappyMonitor',
  ...
  finance: {
    ...
    siteName: 'Sang Finance Monitor',
    shortName: 'SangFinanceMonitor',
  ...
  commodity: {
    ...
    siteName: 'Sang Commodity Monitor',
    shortName: 'SangCommodityMonitor',
